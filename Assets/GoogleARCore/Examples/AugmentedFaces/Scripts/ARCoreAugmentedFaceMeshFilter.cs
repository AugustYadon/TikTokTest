...
namespace GoogleARCore.Examples.AugmentedFaces
{
    ...
    public class ARCoreAugmentedFaceMeshFilter : MonoBehaviour
    {
        ...
        [SerializeField] private bool _useOptionalOffset;
        private Vector3 _optionalOffset = Vector3.zero;
        ...
        public void Awake()
        {
            if (_useOptionalOffset)
                _optionalOffset = transform.localPosition;
            m_Mesh = new Mesh();
        ...
        public void Update()
        {
            ...
            transform.localPosition += _optionalOffset;
